...
(function (global, factory) {
	...
	*/
	...
	(function () {
	  var Particle, canvas, colors, context, draw, drawables, rand, update, min, max, colors, particles;
	  min = 1;
	  max = 6;
	  particles = 100;
	  colors = ["32, 192, 255", "227, 234, 255", "255, 255, 255", "200, 200, 200"];
	  rand = function (a, b) {
	  ...
	  Particle = function () {
	    ...
	    Particle.prototype.update = function () {
	      ...
	      if (this.type === "dust") this.opacity = Math.min(1, Math.max(0, this.opacity));else this.opacity = 1;
